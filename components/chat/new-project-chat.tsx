...
const NewProjectChat = ({
  ...
  const suggestions = [
    ...
    },
    {
      ...
      value: "A cutting-edge landing page for an autonomous AI workflow platform. Deep space dark mode with vibrant indigo radial light-leaks, floating glassmorphic navbar, hero with glowing gradient text, bento grid showcasing features, and Velo pricing section."
    },
    {
    ...
    },
    {
      ...
      value: "A Dribbble-quality landing page for a modern global payments app. The theme alternates between a deep, dark forest/emerald green and pristine white. The primary accent color is a vibrant neon Emerald Green. The Hero section is dark mode with an emerald radial light-leak, featuring a centered massive H1, a floating UI card representing a mobile banking interface, and smaller glassmorphic pill badges floating around it (e.g., 'Total Balance'). Follow this with a pristine white section containing a muted partner logo cloud, a 6-card bento grid for features with green icons, and two 2-column split sections matching text/checklists against large floating white UI cards. Include a dark-mode pricing section with 3 glassmorphic cards and emerald accents, a white testimonials grid, and a massive dark-green rounded CTA card with an inner radial glow placed just above a Velo, dark-mode footer."
    },
    {
    ...
    //     value: "The 'Titan Wealth' dashboard. A 'Glassmorphism' masterclass with blurred backdrop filters and glowing neon-blue data lines. Features a 3D rotating globe for 'Global Assets', modular frosted-glass cards for crypto-wallets, and a Velo, dark-mode 'Command Bar' for instant transactions."
    // },
    // {
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        ">
          ...
          <motion.p
            ...
            '
          >
            Describe your vision, and watch Velo transform
